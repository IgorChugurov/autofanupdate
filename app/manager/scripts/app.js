...
var myApp= angular.module('myApp', [
        'ngRoute','ui.router','ngResource','ngCookies','ui.select2','ui.bootstrap','ngAnimate', 'fx.animations','ui.select',
        'angularFileUpload',
        'i.mongoPaginate',
  'toaster',
  'myApp.controllers',
...
.config(['$stateProvider', '$urlRouterProvider','$locationProvider',function ($stateProvider,$urlRouterProvider,$locationProvider){
    ...
    $stateProvider
        ...
        .state("mainFrame.vendor", {
            url: "/vendor/:id",
            templateUrl: function(){ return 'manager/views/partials/vendor.html' },
            controller: 'vendorCtrl'
        })
        .state("mainFrame.store", {
            url: "/store/:id",
            templateUrl: function(){ return 'manager/views/partials/store.html' },
            controller: 'storeCtrl'
        })
        .state("mainFrame.invoice", {
            url: "/invoice/:id",
            templateUrl: function(){ return 'manager/views/partials/invoice.html' },
            controller: 'invoiceCtrl'
        })
        .state("mainFrame.cash", {
            url: "/cash/:id",
            templateUrl: function(){ return 'manager/views/partials/cash.html' },
            controller: 'cashCtrl'
        })
        .state("mainFrame.maker", {
            url: "/maker/:id",
            templateUrl: function(){ return 'manager/views/partials/maker.html' },
        ...
        .state("mainFrame.customerList.custom", {
            url: "/custom/:id?clone",
            template:'<invoice-item></invoice-item>'
        })
        ...
        /*.state("mainFrame.shippers", {
            url: "/shippers",
            templateUrl: function(){ return 'manager/views/partials/shippers.html' },
        ...
        .state("mainFrame.convert", {
            url: "/convert",
            templateUrl: function(){ return 'manager/views/partials/convert.html' },
            controller: 'convertCtrl'
        })

        .state("mainFrame.slides", {
            url: "/slides",
            ...
            templateUrl: function(){ return 'manager/views/partials/slides.html' },
            controller: 'slidesCtrl'
        })

        .state("frame.customers", {
            url: "/customer",
            template: '<customer-list></customer-list>',
        })
        .state("frame.customers.customer", {
            url: "/:id",
            template:'<customer-item></customer-item>',
        })
